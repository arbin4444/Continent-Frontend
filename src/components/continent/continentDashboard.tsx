...
export const ContinentDashboard: React.FC = () => {
  ...
  return (
    <>
      <EuiFlexGroup direction="column" className="dashboard-mainGrp">
        <ComponentTab />
        <div className="dashboard-title">
        <EuiText>Dashboard Summary</EuiText>
        <EuiHorizontalRule margin="xs"/>
        </div>
        <EuiPanel className="dashboard-panel">
          <EuiFlexGrid columns={2}>
            <EuiFlexItem>
              <Chart size={{ height: 300 }}>
                <Settings baseTheme={LIGHT_THEME} theme={themeOverrides} />
                <Partition
                  id="pieByCP"
                  data={chartData || []}
